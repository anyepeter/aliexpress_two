...
import { ShoppingBag, Store, ArrowLeft, TrendingUp, Shield, Users } from "lucide-react";
...
export default async function BecomeSellerPage() {
  ...
  if (user.role !== "BUYER") redirect("/seller/dashboard");
          ...
          <div className="max-w-2xl mx-auto w-full px-6 py-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 mt-1">
                Hi {user.firstName}! Complete the steps below to set up your store. Your
                personal info is already filled in.
              </p>
            </div>
